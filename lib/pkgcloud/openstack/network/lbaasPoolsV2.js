...
lbaasPoolsV2.prototype._setProperties = function (details) {
  ...
  this.healthmonitor_id = details.healthmonitor_id || this.healthmonitor_id;
  this.listeners = details.listeners || this.listeners;
...
lbaasPoolsV2.prototype.toJSON = function () {
  ...
  'name', 'project_id', 'protocol', 'subnet_id','tenant_id', 'healthmonitor_id', 'listeners',
  'members', 'id']);
};
