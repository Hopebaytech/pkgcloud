 ...
 * @param {String}    options.name      the name of the new secret
 * @param callback
 */
...
_convertSecretToWireFormat = function (details){
  ...
  wireFormat.algorithm = details.algorithm;
  wireFormat.bit_length = details.bit_length;
  wireFormat.mode = details.mode;
  wireFormat.payload = details.payload;
  wireFormat.payload_content_type = details.payload_content_type;
